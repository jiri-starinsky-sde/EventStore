...
namespace EventStore.Projections.Core.Services.Management
{
        ...
        IHandle<ProjectionCoreServiceMessage.SubComponentStopped>
    {
        ...
        public void Handle(ProjectionCoreServiceMessage.SubComponentStarted message)
        {
            ...
            Log.Debug("====================================SubComponentStarted: {0} _pendingStarts: {1}, _activeStarts: {2}",message.SubComponent,_pendingSubComponentsStarts,_activeSubComponents);
        ...
        {
            _activeSubComponents--;
            Log.Debug("====================================SubComponentStopped: {0} _pendingStarts: {1}, _activeStarts: {2}",message.SubComponent,_pendingSubComponentsStarts,_activeSubComponents);
